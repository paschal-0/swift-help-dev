...
const navLinkClass =
  "relative inline-flex h-11 items-center justify-center overflow-hidden rounded-[32px] px-3 text-[16px] font-normal tracking-[-0.05em] lg:h-14 lg:px-[22px] lg:text-[24px] max-[767px]:h-11 max-[767px]:w-full max-[767px]:px-3.5 max-[767px]:text-[18px]";
...
export function Navbar() {
  ...
  return (
    <nav className="relative flex min-h-[82px] items-center justify-between rounded-[200px] bg-white px-4 py-3 shadow-[0_15px_65px_rgba(30,136,229,0.15)] lg:min-h-[109px] lg:px-10 lg:py-5 max-[767px]:z-50 max-[767px]:h-[62px] max-[767px]:min-h-0 max-[767px]:flex-nowrap max-[767px]:rounded-[400px] max-[767px]:px-6 max-[767px]:py-2.5">
      <a
        href="#home"
        className="inline-flex items-center gap-1 text-[22px] font-medium tracking-[-0.05em] text-[#1e88e5] lg:text-[28px] max-[767px]:text-[22px]"
      >
      ...
      <div
        className={
          isMenuOpen
            ? "absolute left-0 right-0 top-[calc(100%+16px)] z-40 flex flex-col gap-4 rounded-3xl bg-white p-6 shadow-[0_15px_65px_rgba(30,136,229,0.15)] min-[768px]:static min-[768px]:top-auto min-[768px]:z-auto min-[768px]:flex min-[768px]:w-auto min-[768px]:flex-row min-[768px]:items-center min-[768px]:gap-1 min-[768px]:rounded-none min-[768px]:bg-transparent min-[768px]:p-0 min-[768px]:shadow-none lg:min-[768px]:gap-2"
            : "hidden items-center gap-1 min-[768px]:flex lg:min-[768px]:gap-2"
        }
      >
        {links.map((link) => (
          <motion.a
